	...
	public function new(?DPad:FlxDPadMode, ?Action:FlxActionMode)
	{
		...
		switch (Action)
		{
			...
			case A_X:
				...
				actions.add(add(buttonA = createButton(FlxG.width - (44 * 3) * 2, FlxG.height - (45 * 3), 44 * 3, 45 * 3, "a")));
			case A_B:
				actions.add(add(buttonA = createButton(FlxG.width - 44 * 3, FlxG.height - 45 * 3, 44 * 3, 45 * 3, "a")));
			...
			case P:
				actions.add(add(buttonP = createButton(FlxG.width - (44 * 3), FlxG.height / 2 - (45 * 3) / 2, 44 * 3, 45 * 3, "p")));
			case NONE: // do nothing
		}
	}
