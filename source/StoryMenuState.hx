...
class StoryMenuState extends MusicBeatState
{
	...
	function updateText()
	{
		var char0:String = weekCharacters[curWeek][0];
		if (char0 != "")
		{
			grpWeekCharacters.members[0].visible = true;
			grpWeekCharacters.members[0].animation.play(char0);
		}
		else
		...
		if (grpWeekCharacters.members[0].visible)
			switch (grpWeekCharacters.members[0].animation.curAnim.name)
			{
				...
				case 'bao':
					grpWeekCharacters.members[0].offset.set(200, 175);
