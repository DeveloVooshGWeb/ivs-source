...
class KeysMenu extends MusicBeatState
{
	...
	ourFuckingList.push("Up Bound TO " + gtk(0));
	ourFuckingList.push("Left Bound TO " + gtk(1));
	ourFuckingList.push("Down Bound TO " + gtk(2));
	ourFuckingList.push("Right Bound TO " + gtk(3));
	
	ourFuckingList.push("Alt Up Bound TO " + gtk(4));
	ourFuckingList.push("Alt Left Bound TO " + gtk(5));
	ourFuckingList.push("Alt Down Bound TO " + gtk(6));
	ourFuckingList.push("Alt Right Bound TO " + gtk(7));
